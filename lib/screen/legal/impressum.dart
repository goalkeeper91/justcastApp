                                       ...
                                       text: TextSpan(
                                           children: <TextSpan>[
                                             ...
                                             TextSpan(text:' https://ec.europa.eu/consumers/odr.\n', style: const TextStyle(color: Colors.blue), recognizer: TapGestureRecognizer()
                                               ..onTap = () async {
                                                 const url = 'https://ec.europa.eu/consumers/odr';
                                             ...
                                             const TextSpan(text: 'Verbraucherstreitbeilegung/Universalschlichtungsstelle\n', style: const TextStyle(fontWeight: FontWeight.bold)),
                                             ...
                                             const TextSpan(text: 'Haftung für Inhalte\n', style: const TextStyle(fontWeight: FontWeight.bold)),
                                             ...
                                             const TextSpan(text: 'Haftung für Links\n', style: const TextStyle(fontWeight: FontWeight.bold)),
                                             ...
                                             const TextSpan(text: 'Urheberrecht\n', style: const TextStyle(fontWeight: FontWeight.bold)),
